		...
		<div id="articleEditor">
			<div class="board_write">
				...
				<div id="pre_set" style="display: none">
					수정된 부분 개수 : <input type="number" min="1" max="100" id="addCountCondition" name="addCountCondition" value="0" style="width: 50px">
					추가된 개행개수 : <input type="number" min="1" max="50" id="newLineCountCondition" name="newLineCountCondition" value="0" style="width: 50px">
					(oc-mc)/oc : <input type="number" min="-2" max="-0.2" id="stringSizeDifferenceCondition" name="stringSizeDifferenceCondition" value="0" style="width: 50px">
					추가된 문자열길이 :<input type="number" min="100" max="1000" id="addLengthCondition" name="addLengthCondition" value="0" style="width: 50px">
