...
<body>
    ...
    <h1 style="font-size:3rem; font-weight: normal;"><img src="${pageContext.request.contextPath}/img/history.png" style="max-height: 1em;"/>버전 관리 페이지 <button class="btn btn-primary" style="float:right;" onclick="location.href='${path}/assignment'">홈으로</button></h1> 
